    ...
    <div class="d-flex justify-content-center h-100">
        <div class="card">
            <div class="card-header">
                @isset($url)
                <h3>Sign In (Admin) <img src="/../ekshop.PNG" alt="ekShop" class="logoimg"></h3>
                @else
            ...
            <div class="card-footer">
                ...
                <div class="d-flex justify-content-center">
                    ...
                    @endif
                    <!-- @isset($url)
                    <a class="btn admin" href="{{ route('login') }}">{{ __('User Login') }}</a>
                    @else
                    <a class="btn admin" href="{{ url('login/admin') }}">{{ __('Admin Login') }}</a>
                    @endisset -->
                </div>
            </div>
                @isset($url)
